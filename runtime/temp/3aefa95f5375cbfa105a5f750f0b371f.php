<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:26:"lantern/lantern_index.html";i:1512312004;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
    ...
    <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
                <li class="active"><a href="">品牌维护</a></li>
                <li><a href="#type">型号维护</a></li>
